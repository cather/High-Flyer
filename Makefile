...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Apr 29 20:56:32 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/game_catherhj1.0.0/ && $(COPY_FILE) --parents alien.h clickscene.h laser.h mainwindow.h meteor.h missile.h mylist.h planet.h rocket.h thing.h .tmp/game_catherhj1.0.0/ && $(COPY_FILE) --parents alien.cpp clickscene.cpp laser.cpp main.cpp mainwindow.cpp mainwindow_constructor.cpp meteor.cpp missile.cpp planet.cpp rocket.cpp thing.cpp .tmp/game_catherhj1.0.0/ && (cd `dirname .tmp/game_catherhj1.0.0` && $(TAR) game_catherhj1.0.0.tar game_catherhj1.0.0 && $(COMPRESS) game_catherhj1.0.0.tar) && $(MOVE) `dirname .tmp/game_catherhj1.0.0`/game_catherhj1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/game_catherhj1.0.0
