...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue May 7 10:01:07 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/game_catherhj1.0.0/ && $(COPY_FILE) --parents alien.h clickscene.h laser.h mainwindow.h megastar.h meteor.h missile.h mylist.h planet.h rocket.h star.h thing.h .tmp/game_catherhj1.0.0/ && $(COPY_FILE) --parents alien.cpp clickscene.cpp laser.cpp main.cpp mainwindow.cpp mainwindowimplementations.cpp megastar.cpp meteor.cpp missile.cpp planet.cpp rocket.cpp star.cpp thing.cpp .tmp/game_catherhj1.0.0/ && (cd `dirname .tmp/game_catherhj1.0.0` && $(TAR) game_catherhj1.0.0.tar game_catherhj1.0.0 && $(COMPRESS) game_catherhj1.0.0.tar) && $(MOVE) `dirname .tmp/game_catherhj1.0.0`/game_catherhj1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/game_catherhj1.0.0
...
mainwindowimplementations.o: mainwindowimplementations.cpp mainwindow.h \
		clickscene.h \
		thing.h \
		rocket.h \
		laser.h \
		...
		megastar.h \
		mylist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainwindowimplementations.o mainwindowimplementations.cpp

megastar.o: megastar.cpp megastar.h \
		thing.h \
		rocket.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o megastar.o megastar.cpp
